<template lang="pug">
    div
        ...
        .tile.is-ancestor
            .tile.is-parent.is-vertical(v-for="linkCategory in linkCategories")
                section.section
                    .card            
                        header.card-header
                            h1.card-header-title {{linkCategory.name}}
                        .card-content
                            ul
                ...
                },
                {
                    ...
                    links: [
                        { 
                            ...
                            description: "Brian Krebs Blog"
                        },
                        { 
                            url: "https://www.hackthebox.eu/",
                            name: "Hack The Box - Penetration Labs / Challenges",
                            description: ""
                        }
                    ]
                },
